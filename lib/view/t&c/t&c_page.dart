...
class _TermsAndConditionsState extends State<TermsAndConditions> {
  ...
  _load() async {
    await utilityController.getTermCondition();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Obx(
        () => Center(
          child: utilityController.isTermsConditionLoad.value
              ? Column(
              ...
              : Scrollbar(
                  ...
                  child: ListView(
                    ...
                    children: [
                      const Center(
                          child:
                              CustomTextSimple(text: "Terms and Conditions")),
                      Html(
                        data: utilityController.termsCondition.value,
                        style: {
                          "table": Style(
                            backgroundColor:
